...
<!--       <b-dropdown-item><i class="icon-user-follow text-success"></i> New user registered</b-dropdown-item>
      ...
      <b-dropdown-item><i class="icon-basket-loaded text-success"></i> New Order - $105.00</b-dropdown-item>
      <b-dropdown-item><i class="icon-basket-loaded text-success"></i> New Order - $90.00</b-dropdown-item>
      <b-dropdown-item><i class="icon-basket-loaded text-success"></i> New Order - $135.00</b-dropdown-item>
      <b-dropdown-item><i class="icon-basket-loaded text-success"></i> New Order - $60.00</b-dropdown-item>
      <b-dropdown-item><i class="icon-basket-loaded text-success"></i> New Order - $140.00</b-dropdown-item>
