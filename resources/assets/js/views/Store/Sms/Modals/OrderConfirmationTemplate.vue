  ...
  <div class="row mt-3">
    <div class="col-md-12 pb-3">
      ...
      <p class="pb-2">
        ...
        {{ smsSettings.orderConfirmationTemplatePreview }}
      </p>
      <div class="d-flex">
...
export default {
  ...
  methods: {
    ...
    update() {
      if (this.smsSettings.autoSendOrderConfirmationTemplate === "") {
        this.$toastr.w(
    ...
    addTag(tag) {
      this.smsSettings.autoSendOrderConfirmationTemplate += "{" + tag + "}";
