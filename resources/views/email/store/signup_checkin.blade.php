                ...
                <tr>
                  <td align="center">
                    <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <!-- title -->
                      <tr>
                        <td align="right" style="font-family: 'Open Sans', Arial, sans-serif; font-size:28px; color:#3b3b3b; line-height:26px;">Checking In</td>
                      </tr>
                      <!-- end title -->
                      <tr>
                        <td height="25"></td>
            ...
            <td>
              <table class="table-inner" width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <p>Hi {{ $store->user->userDetail->firstname }}</p>

                  <p>We hope you are enjoying your GoPrep experience so far. This email is just a reminder that we are here to help. We'll help you understand how everything works, get you familiar with the system, and help you adjust your settings and set up your menu. We want this process to be as quick and painless for you as possible so you can get started selling to your customers.</p>

                  <p>Do you think the platform doesn't have everything you need to fit your business model? Just ask us. There are a ton of hidden features and capabilities that allow us to accommodate companies from all over the world.</p>
