                ...
                <tr>
                  <td align="center">
                    <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <!-- title -->
                      <tr>
                        <td align="right" style="font-family: 'Open Sans', Arial, sans-serif; font-size:38px; color:#3b3b3b; line-height:26px;">Failed Renewal</td>
                      </tr>
                      <!-- end title -->
                      <tr>
                        <td height="25"></td>
                      ...
                      <tr>
                      	<td align="right" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#7f8c8d; line-height:26px;"> 
                          {{ $user['user_detail']['city'] }}, {{ $user['user_detail']['state'] }} {{ $user['user_detail']['zip'] }}
                        </td>
                      </tr>
              ...
              <table align="center" width="100%" class="table-inner" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td align="left" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#7f8c8d; line-height:26px;"> 
                  	Unfortunately your subscription failed to automatically renew.
                  </td>
                </tr>
                <tr>
                  <td height="18"></td>
                ...
                <tr>
                  <td align="left" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#7f8c8d; line-height:26px;">
                  	The following error occurred: <br/><i>{{ $error }}</i>
                  </td>
                 </tr>
                 <tr>
                  <td height="17"></td>
                 ...
                 <tr>
                  <td align="left" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#7f8c8d; line-height:26px;">
                  	If the error is credit card related, please update your credit card and contact us to resume your subscription.
                  </td>
                </tr>
                <tr>
                  <td height="17"></td>
