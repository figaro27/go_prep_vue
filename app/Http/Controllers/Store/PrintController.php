...
use App\Exportable\Store\OrderSummary;
use App\Exportable\Store\PackageOrderSummary;
...
class PrintController extends StoreController
{
    public function print(Request $request, $report, $format = 'pdf')
    {
        ...
        switch ($report) {
            ...
            case 'order_summary':
                $exportable = new OrderSummary($this->store, $params);
                break;

            case 'package_order_summary':
                $exportable = new PackageOrderSummary($this->store, $params);
                break;
            ...
            case 'order_labels':
                $exportable = new OrderLabels($this->store, $params);
                break;
