                ...
                <tr>
                  <td align="center">
                    <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <!-- title -->
                      <tr>
                        <td align="right" style="font-family: 'Open Sans', Arial, sans-serif; font-size:38px; color:#3b3b3b; line-height:26px;">New Subscription</td>
                      </tr>
                      <!-- end title -->
                      <tr>
                        <td height="25"></td>
                      ...
                      <!-- company name -->
                      <tr>
                        <td align="right" style="font-family: 'Open Sans', Arial, sans-serif; font-size:16px; color:#3b3b3b; line-height:26px; font-weight: bold;">{{ $subscription->user->details->name }}</td>
                      </tr>
                      <!-- end company name -->
                      <!-- address -->
                      <tr>
