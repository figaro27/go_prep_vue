  ...
  <div class="row">
    ...
    <table class="no-border table-heading" style="border-style:none;">
      <thead>
          ...
          <th class="top-right-border-radius drop-shadow no-border" style="text-align:right;padding-right:25px">Price</th>
      </thead>
      ...
      <tbody>
        ...
        <tr class="{{ $i % 2 === 0 ? 'evenrow' : 'oddrow' }}">
          ...
          <td style="text-align:right;padding-right:20px">{{$currency}}{{number_format($mealPackageItem->price * $mealPackageItem->quantity, 2)}}</td>
        </tr>
