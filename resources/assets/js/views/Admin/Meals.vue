<template>
  <div>
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <button class="btn btn-success btn-sm" @click="showCreateMealModal">
              Add New
            </button>
            ...
            >
              <div slot="featured_image" slot-scope="props">
                <img :src="tableData[props.index].image.thumb_url" />
              </div>
              <div slot="actions" class="text-nowrap" slot-scope="props">
                ...
                <button
                  ...
                  @click="editMeal(props.row.id)"
                >
                  Edit
                </button>
                <button
                  class="btn btn-danger btn-sm"
                  @click="showDeleteMealModal(props.row.id)"
                >
                  Delete
                </button>
              </div>
    ...
    <b-modal
      size="lg"
      title="Meal"
      v-model="createMealModal"
      v-if="createMealModal"
    >
      <b-list-group>
        <b-list-group-item
          ><b-form-input
            v-model="newMeal.featured_image"
      ...
      <button class="btn btn-primary mt-3 float-right" @click="storeMeal">
        Add Meal
      </button>
    </b-modal>
    ...
    >
      <b-list-group>
        ...
        <b-list-group-item
          >Description: {{ meal.description }}</b-list-group-item
        >
    ...
    <b-modal title="Meal" v-model="editMealModal" v-if="editMealModal">
      <b-list-group>
        ...
        ></b-list-group-item>
        <b-list-group-item
          ><b-form-input v-model="meal.category"></b-form-input
        ></b-list-group-item>
        <b-list-group-item
    ...
    <b-modal title="Meal" v-model="deleteMealModal" v-if="deleteMealModal">
      <center>
        ...
        <button class="btn btn-danger mt-3" @click="deleteMeal(mealID)">
          Delete
        </button>
      </center>
    </b-modal>
...
export default {
  ...
  methods: {
    getTableData() {
      let self = this;
      axios.get("../meals").then(function(response) {
