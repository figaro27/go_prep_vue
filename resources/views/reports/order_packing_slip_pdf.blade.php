            ...
            <tr>
              ...
              <td style="width:35%;margin-left:0px;padding-left:0px">
                <table border="0" style="border:0px;border-style:none;border-collapse: collapse">
                  ...
                  @if ($order->balance > 0)<tr><td style="border:none"><b>Paid</b></td><td style="border:none">${{number_format($order->amount - $order->balance, 2)}}</td></tr>@endif
                  @if ($order->balance > 0)<tr><td style="border:none"><b>Balance</b></td><td style="border:none">${{number_format($order->balance, 2)}}</td></tr>@endif
                </table>
              </td>
            </tr>
          </table>
