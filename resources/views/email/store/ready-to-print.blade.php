                ...
                <tr>
                  <td align="center">
                    <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                      ...
                      <!-- title -->
                      <tr>
                        <td align="right" style="font-family: 'Open Sans', Arial, sans-serif; font-size:38px; color:#3b3b3b; line-height:26px;">Reports Ready</td>
                      </tr>
                      <!-- end title -->
                      <tr>
                        <td height="25"></td>
                      ...
                      <tr>
                        <td align="right" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#7f8c8d; line-height:26px;"> Delivery Date - {{ date('D, m/d/Y', strtotime($store->next_locked_in_date)) }}
                          </td>
                      </tr>
              ...
              <table align="center" width="100%" class="table-inner" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td align="left" style="font-family: 'Open Sans', Arial, sans-serif; font-size:16px; color:#3b3b3b; line-height:26px;  font-weight: bold; text-transform:uppercase"> 
                  	Hello {{ $store->user->userDetail->full_name }},
                  </td>
                </tr>
                <!-- end title -->
                <tr>
                ...
                <!-- content -->
                <tr>
                  <td align="left" style="font-family: 'Open Sans', Arial, sans-serif; font-size:13px; color:#7f8c8d; line-height:26px;"> Your reports are ready to be viewed for the next locked in delivery date: <br><b>{{ date('D, m/d/Y', strtotime($store->next_locked_in_date)) }}.</b> Click the button below to view your reports.
                  </td>
                </tr>
                <tr>
                  <td height="25"></td>
                ...
                <tr>
                <td><a href="http://goprep.com/store/reports"><button bgcolor="#E04F00" align="center" style="font-family:'Open Sans'; font-size:16px; color:#ffffff;padding-left:25px;padding-right:25px;border-radius:5px;background-color:#F25727;width:100%;height:55px;border:none">View Reports</button></a></td>
                </tr>
