  ...
  <div class="row">
    ...
    <table class="no-border" style="border-style:none">
      ...
      <tfoot>
        @if ($order->balance > 0)
        <tr>
          <th class="full-left-border-radius bold-text drop-shadow" style="border:none;font-size:18px;position:relative;left:30px">
          Amount Due</th>
          <th class="full-right-border-radius bold-text drop-shadow" style="border:none;font-size:18px;text-align:right;position:relative;right:20px">${{number_format($order->balance, 2)}}</th>
        </tr>
        @endif
        @if ($order->balance <= 0)
        <tr>
          <th class="full-left-border-radius bold-text drop-shadow" style="border:none;font-size:18px;position:relative;left:30px"><b>Total Paid</b></th>
          <th class="full-right-border-radius bold-text drop-shadow" style="border:none;font-size:18px;text-align:right;position:relative;right:20px">{{ $amount }}</th>
        </tr>
        @endif
      </tfoot>
    </table>
